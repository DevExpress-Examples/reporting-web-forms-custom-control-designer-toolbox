...
function getSerializationsInfoWithNewDataBindings(serializationsInfo, newDataBindingsName) {
    ...
    newDataBindingsName.forEach(function (name) {
        DevExpress.Designer.Report.dataBindingsSerializationInfo.push({ propertyName: name, displayName: name, editor: DevExpress.Designer.Report.editorTemplates.dataBinding });
    });
    // Create new data bindings
    var newDataBindings = DevExpress.Designer.Report.dataBindings([].concat(dataBindings.allDataBindings, newDataBindingsName));
...
var somePropertySerializationInfo = { propertyName: "someProperty", displayName: "Some Property", modelName: "@SomeProperty", defaultVal: "", editor: DevExpress.Designer.Widgets.editorTemplates.text };
var bindablePropertySerializationInfo = { propertyName: "bindableProperty", displayName: "Bindable Property", modelName: "@BindableProperty", defaultVal: "", editor: DevExpress.Designer.Widgets.editorTemplates.text };

// Create new serialization information
var newSerializationsInfo = getSerializationsInfoWithNewDataBindings(DevExpress.Designer.Report.labelSerializationsInfo.slice(0), ["BindableProperty"]);
// Remove old default data binding
newSerializationsInfo.splice(newSerializationsInfo.indexOf(newSerializationsInfo.filter(function (pr) { return pr.propertyName === "defaultDataBinding" })[0]), 1);
// Create new default data binding
var newDefaultBinding = DevExpress.Designer.Report.defaultDataBinding("BindableProperty");

newSerializationsInfo = [].concat(newSerializationsInfo, [somePropertySerializationInfo, bindablePropertySerializationInfo, newDefaultBinding]);

// Create new popular property
var newPopularProperties = [].concat(DevExpress.Designer.Report.popularPropertiesLabel.slice(0), ["someProperty", "bindableProperty"]);
